...
#include F:\Program Files\AutoHotkey\Scripts\AHK Script Manager\scripts\gmailFireCloverPad_simple.ahk
...
;rz
#IfWinActive, RunZ ahk_exe AutoHotkey.exe ;working now in win 10 !
::cdc::
...
Return
::usr::
openfile("E:\EasyOSLink\PCMasterMove\Downloads\Compressed\RunZ\Doc\用户手册.md")
return
::9::
ActQQ("9")
Return
...
Return
::163send::
Run,G:\SysManage\SoftFolders\TCPTraceLearn\tcpTrace.exe /listen 9901 /serverPort 25 /serverName smtp.163.com /title 163MailSend_9901
return 
::163pick::
...
Return
::tc::
StringActivate("Totalcmd64.exe","tc64")
return
::ww::
...
return
::ff::
StringActivate("firefox.exe","fire")
SwitchToEngIME()
return
::gg::
...
return
::des13::
StringActivate("designer.exe","E:\EasyOSLink\Run\AdminWork\des13.lnk")
return
::dd::
...
return
::aa::
openfile("F:\Program Files\AutoHotkey\Scripts\AHK Script Manager\scripts\gmailFireCloverPad_simple.ahk")
return
::keep::
...
return
::rup::
DllCall("SetCursorPos", int, 1300, int, 20)
return
::ahkm::
Run,"F:\Program Files\AutoHotkey\Scripts\AHK Script Manager"
return
::en:: 
 SwitchIME(00000409)
 return
...
::sni::
StringActivateName("SnippingTool.exe","SnippingTool.exe")
return
