...
battText1 = xx
battText2 := "100%"
battWidth := GetTextSize(battText1, infoFontStyle "," Webdings )+5
battWidth += GetTextSize(battText2, infoFontStyle "," infoFont )+5

memText := memLabel . "100%"
memWidth := GetTextSize(memText, infoFontStyle "," infoFont )+5

cpuText := cpuLabel . "100%"
cpuWidth := GetTextSize(cpuText, infoFontStyle "," infoFont )+5
...
UPDATECPU:
    ...
    load := floor((400 - 0.01*(IdleTime - IdleTime0)/(Tick - Tick0))/4)
    SetFormat, Float, 0.2
    load += 0
