...
*/
#IfWinNotActive,ahk_exe cmd.exe|MultiDesk64.exe|bash.exe|sh.exe|cmder.exe ;this helps to ensure ems in robert pc is not quit after double click of the mstsc title
~LButton::
MouseGetPos, xx
TimeButtonDown = %A_TickCount%
; Wait for it to be released
